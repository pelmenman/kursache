...
TEST(CoincidenceTest, TestCoincidenceWithKnuttPredictor) {
    ...
    KnuthMorrisPrattPredictor predictor("hello");
    Coincidence<KnuthMorrisPrattPredictor> coincidence(text, predictor);
...
TEST(CoincidenceTest, TestCoincidenceWithBMPredictor) {
    ...
    BoyerMoorePredictor predictor("hello");
    Coincidence<BoyerMoorePredictor> coincidence(text, predictor);
    std::vector<std::tuple<double, int>> expected {
            std::make_tuple(1, 8),
            std::make_tuple(1, 26)
    };
